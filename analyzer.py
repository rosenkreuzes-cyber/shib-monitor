...
class MarketAnalyzer:
    ...
    def trade_okj(self, d):
        self.trade({
            "id": d.get("tradeId"),
            "price": d.get("px"),
            "amount": d.get("sz"),
            "side": d.get("side"),
            "executed_at": d.get("ts"),
        })
    ...
    def diff_depth(self, d):
        ...
        self.set_source("okj_ws_orderbook")
