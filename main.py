...
VERSION="5.5-okj-tradefix"; PAIR="SHIB-JPY"
...
def health():
    ...
    "ws_connected":s["ws_connected"],"ws_transport_connected":getattr(stream,"ws_transport_connected",False),
    ...
    "ws_reconnects":getattr(stream,"ws_reconnects",0),"last_ws_trade_ts":getattr(stream,"last_ws_trade_ts",None),
